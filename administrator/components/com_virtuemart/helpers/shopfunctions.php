 ...
 * @version $Id: shopfunctions.php 8828 2015-04-13 13:58:32Z Milbo $
 */
class ShopFunctions {
	...
	*/
	...
	static function getValidProductFilterArray () {
		...
		if (!isset($filterArray)) {
			...
			'product_price', '`p`.product_special', '`p`.product_recommend','`p`.product_sales', '`p`.product_availability', '`p`.product_available_date',
			...
			'`p`.modified_on','product_price_asc', 'product_price_desc',
