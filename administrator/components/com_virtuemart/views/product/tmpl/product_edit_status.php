...
<table class="adminform" width="100%">
	...
	<!-- low stock notification -->
		...
		<th style="text-align:right;">Stock availability
		</th>
		<td>
			<input readonly type="text" class="inputbox"  name="" value="<?php echo $this->product->product_in_stock - $this->product->product_ordered; ?>" size="10" />
		</td>
