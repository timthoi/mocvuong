 ...
 * @version $Id: product_edit_customer.php 8531 2014-10-26 16:49:57Z Milbo $
 */
		...
		<td width="21%" valign="top">
			...
			<div id="customer-mail-notify-list">
				...
				<table class="adminlist table" cellspacing="0" cellpadding="0">
					<thead>
					<tr>
						<th class="title" style='text-align:left!important'><?php echo vmText::_ ('COM_VIRTUEMART_EMAIL');?></th>
					</tr>
					</thead>
					<tbody id="customers-notify-list">
						...
						if (isset($this->waitinglist) && count ($this->waitinglist) > 0) {
							...
							foreach ($this->waitinglist as $key => $wait) {
								$row = '<tr class="row'.$i.'"><td><a href="mailto:' . $wait->notify_email . '">' . $wait->notify_email . '</a></td></tr>';
								echo $row;
								$i = 1 - $i;
							}
						}
