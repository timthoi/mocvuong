 ...
 * @version $Id: product_edit_information.php 8835 2015-04-16 10:24:55Z Milbo $
 */
    ...
    <table class="adminform" width="100%">
		<tr class="row<?php echo $i?>">
			...
			<td colspan="2">
				...
				<label><?php echo VmHTML::checkbox('product_recommend', $this->product->product_recommend); ?> <?php echo 'Recommend' ?></label>				
			</td>
			<td>
