...
<form method="post" action="index.php?option=com_rsform" name="adminForm">
	<p>
		<button class="rs_button rs_left" type="button" onclick="submitform2('richtext.apply');"><?php echo JText::_('APPLY'); ?></button>
		<button class="rs_button rs_left" type="button" onclick="submitform2('richtext.save');"><?php echo JText::_('SAVE'); ?></button>
