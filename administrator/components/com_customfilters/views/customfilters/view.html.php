...
class CustomfiltersViewCustomfilters extends JViewLegacy{
	...
	public function addToolbar(){
		...
		if (JFactory::getUser()->authorise('core.edit', 'com_customfilters'))	JToolBarHelper::custom('customfilters.savefilters','save','save_f2.png', 'COM_CUSTOMFILTERS_SAVE',false);
