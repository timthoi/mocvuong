...
<form action="<?php echo JRoute::_('index.php?option=?option=com_wishlist&controller=josuserslist');?>" method="post" name="adminForm"  id="adminForm">
<div id="j-main-container">
	...
	<thead>
		<tr>
			<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
				<?php echo JText::_( 'PRODUCT_ASSIGN' ); ?>
			</th>
	...
	for ($i=0, $n=count( $this->rows ); $i < $n; $i++)	{
		...
		$link = JRoute::_( 'index.php?option=com_wishlist&controller=favorites&task=add&uid[]='. $row->id);
		?>
...
<input type="hidden" name="controller" value="josuserslist" />
