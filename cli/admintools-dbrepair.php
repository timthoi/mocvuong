...
class AdmintoolsDbrepair extends JApplicationCli
{
    /**
    ...
    public function execute()
    {
        ...
        $this->out("Admin Tools DB Repair CLI " . ADMINTOOLS_VERSION . " (" . ADMINTOOLS_DATE . ")");
        ...
        {
            $this->out("Database is not MySQL, there's nothing to do here.");
            $this->close();
        }
        ...
        foreach($tables as $table)
        {
            ...
            if (!$isOK)
            {
                $this->out("Table ".$table." is not ok, repairing.");
            ...
            {
                $this->out("Table ".$table." is ok.");
            }

            // Finally, optimize
            $this->out("Optimizing ".$table);
...
$app = JApplicationCli::getInstance('AdmintoolsDbrepair');
