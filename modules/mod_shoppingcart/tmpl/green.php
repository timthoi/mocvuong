...
<div id="my" style="background:url(<?php echo $params->get('cart');?>) no-repeat;background-size: 40px 40px;background-color:#003300 ;font-size:18px;padding:12px;padding-right:65px;width:200px;color:white;"align="right"> My Cart(<?php echo count($data->products);?>)&nbsp;&nbsp;&nbsp;&nbsp;</div> 
<?php
...
if ($show_product_list) {
    ...
    box-shadow: 0 0 20px #003300;display:none;position:absolute;background-color:#D1FFC2;width: 277px;">
	<div >
		<div id="myvalue" style="background-color:#194719;color:white;padding:5px;padding-left:15px;">
		...
		<?php
			...
			foreach ($products as $key=>$product){
				...
				<table >
					...
					<tr>
							<td colspan="6" style="background-color:#198719;text-align:right;width:290px !important;" align="right">
...
<?php } ?>
					<tr>
							<td style="background-color:#003300;color:white; " colspan="2" align="right"><?php if((count($data->products))<1) echo "<h4>Not Any Product In Your Cart";?></td>
					</tr>
					<tr>
							<td style="background-color:#003300;color:white; font-size:17px;" colspan="2" align="right"><h4><?php echo "<h4>SubTotal : ".$sy.$total1; ?></td>
					</tr>
					<tr>
