...
class VirtueMartViewCart extends VmView {
	...
	public function display($tpl = null) {
		...
		if ($this->layoutName == 'select_shipment') {
			...
			$this->checkout_link_html = '<button type="submit"  id="checkoutFormSubmit" name="'.$this->checkout_task.'" value="1" class="vm-button-correct button-2" ><span>' . $text . '</span> </button>';
