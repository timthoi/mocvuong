...
<div class="sprocket-features layout-slideshow<?php echo ($parameters->get('features_show_arrows')=='onhover') ? " arrows-onhover" : ""; ?>" data-slideshow="<?php echo $parameters->get('module_id'); ?>">
	...
	<div class="sprocket-features-arrows">
		<span class="arrow next" data-slideshow-next><i class="fa fa-chevron-right"></i></span>
		<span class="arrow prev" data-slideshow-previous><i class="fa fa-chevron-left"></i></span>
	</div>
	<?php endif; ?>
