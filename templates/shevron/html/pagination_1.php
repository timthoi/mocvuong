...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<i class="icon-first"></i>'.$item->text;
	}

	// Check for "Prev" item
	if ($item->text == JText::_('JPREV'))
	{
		$display = '<i class="icon-previous"></i>'.$item->text;
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		$display = '<i class="icon-next"></i>'.$item->text;
	}

	// Check for "End" item
	if ($item->text == JText::_('JLIB_HTML_END'))
	{
		$display = '<i class="icon-last"></i>'.$item->text;
	}
