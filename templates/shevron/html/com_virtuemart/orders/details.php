...
<div class="vm-wrap">
	...
	<div class="border-one">
		<h2 class="shop-heading"><?php echo vmText::_('COM_VIRTUEMART_ACC_ORDER_INFO'); ?></h2>
		<a class="btn_return_pre_page" href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=user&layout=list_order_user'); ?>"><i class="fa fa-chevron-left"></i> Return to previous page</a>
	</div>
