...
<div class="border-one">
	<h2 class="shop-heading"><?php echo JText::_( 'VM_FAVORITE_LIST' ); ?></h2>
</div>
<?php
...
if (empty( $this->data )){ ?>
	...
	echo "<div class='fav_list fav_table'>";
		...
		if ( $product ):
			...
			if ($tmpl_favbtn_image) $form_deletefavorite .= '<i class="fa fa-times"></i>';
			$form_deletefavorite .='</button>';
			...
			echo "<div class='fav_row'>";
				...
				FavoritesModelFavoriteslist::addtocart($product, JText::_('ADD TO CART'),$product_ord);
				echo "</div>";
			echo "</div>";
		endif;
		}
	...
	if (!$user->guest && $tmpl_afaq_enabled)
	{
		...
		<input type=\"submit\" class=\"modns button art-button art-button\" value=\"".JText::_('VM_AFAQ_BUTTON')."\" title=\"".JText::_('x')."\" />
		</form>\n</div>\n</p>\n";
	}
}
vmJsApi::jQuery();
...
<div class="checkout-button-top">
	<a href='<?php echo JRoute::_("index.php?option=com_content&view=article&id=11", false); ?>' id="continue-btt-2" class="vm-button-correct button-2">
